...
- Verified with focused acceptance／contract tests, all acceptance＋contract tests (535 passed), full repo tests without the opt-in PostgreSQL URL (535 passed, 1 PostgreSQL skip), strict mypy (109 files), Ruff lint／format (109 Python files), Alembic `20260819_09 (head)`, and wheel SHA-256 `c6ee0a723f542f85979530f7298d3ba009ce352f4990f6e9f692ffb187062dff`.

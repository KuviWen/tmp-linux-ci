...
- Verified with focused acceptance／contract tests, all acceptance＋contract tests (535 passed), full repo tests without the opt-in PostgreSQL URL (535 passed, 1 PostgreSQL skip), strict mypy (109 files), Ruff lint／format (109 Python files), Alembic `20260819_09 (head)`, and wheel SHA-256 `2a57b6cf23d88ec3e5d73c2ad6ed0aae9ea31a78d32022873154eec986d183de`.

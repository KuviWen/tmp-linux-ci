...
- [ ] 每個增量使用相同三 seeds、六-cell loss／calibration、八季 tests、cost scenarios 與 hard-gate evidence，並與 price-only neural 及 logistic 比較。
- [ ] 100＋100 shadow predictions、research matrix／listing page 與 OperationsControl 能顯示實際模態支援、age、vintage、候選差異及完整 lineage。

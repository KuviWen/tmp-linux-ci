...
- Execute five distinct market-eligible EOD shadow dates, including planned-stop／restart continuation, staged load, schema compatibility, ten-minute inference boundary, prediction invariants, comparison report, selected approval-policy behavior and disclosure, atomic promotion, and rollback-target verification. Planned downtime does not count as a cycle, and post-restart catch-up cannot backdate observation time.

...
Ticket engineering acceptance and model operational qualification are separate decisions. A Ticket 09 implementation may finish in one day by using explicitly labeled deterministic engineering evidence through the same public governance seams; this proves policy and lifecycle behavior but does not qualify a real model, create a production assignment, or satisfy the P2 operational exit.
